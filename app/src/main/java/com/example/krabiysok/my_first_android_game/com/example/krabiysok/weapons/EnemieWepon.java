 ...
 */
public class EnemieWepon extends Weapon {
    protected EnemieWepon(int bulletReloud, int ammo, Bitmap weapon) {
        super(1500 / GameProcess.fps, 1000, BitmapFactory.decodeResource(
                MainActivity.getContext().getResources(), R.drawable.EnemieWepon));
    }
